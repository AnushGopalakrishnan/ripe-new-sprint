...
- Follow-up on 2026-05-26: visual editor iframe overlays now use a purple design-tool treatment instead of black/red. Hover/can-select uses a subtle dashed purple outline with faint fill; selected uses a stronger purple outline, white/purple square handles around the box, and no movement transition.
