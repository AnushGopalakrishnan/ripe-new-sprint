...
const typography: TypographySpecimen[] = [
  {
    ...
    settings: { family: "Plantin MT Pro Light", size: "1.96875rem", weight: "300", lineHeight: "1.333", letterSpacing: "-0.0044em", wordSpacing: "normal", transform: "none", style: "normal" },
  },
  {
    element: "h2",
    semanticCareersStyle: true,
    name: "H2",
    usage: "Careers founder and section titles",
    sample: "The pillars that Ripe is built on",
    source: "careers-typography.module.css · h2 / .h2",
    settings: { family: "Plantin MT Pro Light", size: "1.53125rem", weight: "300", lineHeight: "1.333", letterSpacing: "-0.0044em", wordSpacing: "normal", transform: "none", style: "normal" },
  },
  {
    name: "Benefits card main",
    usage: "Primary text inside Careers benefit cards",
    sample: "Earn referral commissions for team members you help us hire.",
    source: "careers-typography.module.css · .benefitCardMain",
    settings: { family: "Plantin MT Pro", size: "1.53125rem", weight: "300", lineHeight: "1", letterSpacing: "-0.02em", wordSpacing: "normal", transform: "none", style: "normal" },
    sampleStyle: { fontFamily: "var(--ripe-font-serif-regular)", fontSize: "1.53125rem", fontWeight: 300, lineHeight: 1, letterSpacing: "-0.02em", textAlign: "center" },
  },
  {
    name: "Benefits card label",
    usage: "Small supporting labels inside Careers benefit cards",
    sample: "Flexible Work Hours",
    source: "careers-typography.module.css · .benefitCardLabel",
    settings: { family: "Graphik", size: "0.765625rem", weight: "400", lineHeight: "1", letterSpacing: "0em", wordSpacing: "normal", transform: "none", style: "normal" },
    sampleStyle: { fontFamily: "var(--ripe-font-sans)", fontSize: "0.765625rem", fontWeight: 400, lineHeight: 1, letterSpacing: "0em", textAlign: "center" },
  },
  {
    element: "h3",
    semanticCareersStyle: true,
    ...
    settings: { family: "Plantin MT Pro Light", size: "1.09375rem", weight: "300", lineHeight: "1.2", letterSpacing: "-0.008em", wordSpacing: "normal", transform: "none", style: "normal" },
  },
  {
    element: "h4",
    semanticCareersStyle: true,
    ...
    settings: { family: "Plantin MT Pro Light", size: "0.875rem", weight: "300", lineHeight: "1.2", letterSpacing: "-0.01em", wordSpacing: "normal", transform: "none", style: "normal" },
  },
  {
    element: "p",
    semanticCareersStyle: true,
    ...
    settings: { family: "Plantin MT Pro Light", size: "0.875rem", weight: "300", lineHeight: "1.375", letterSpacing: "0", wordSpacing: "normal", transform: "none", style: "normal" },
  },
  {
