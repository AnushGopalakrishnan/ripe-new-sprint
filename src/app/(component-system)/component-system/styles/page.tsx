...
const typography: TypographySpecimen[] = [
  ...
  },
  {
    ...
    settings: { family: "Graphik", size: "0.875rem", weight: "400", lineHeight: "1", letterSpacing: "0em", wordSpacing: "normal", transform: "none", style: "normal" },
    sampleStyle: { fontFamily: "var(--ripe-font-sans)", fontSize: "0.875rem", fontWeight: 400, lineHeight: 1, letterSpacing: "0em", textAlign: "center" },
  },
  {
    element: "h3",
    semanticCareersStyle: true,
